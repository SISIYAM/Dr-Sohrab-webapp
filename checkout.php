...
if(!isset($_COOKIE['student_id'])){
  ?>
<script>
location.replace("dashboard/login.php?login");
</script>
<?php
}
...
//     // select student
//     $slt = mysqli_query($con, "SELECT * FROM students WHERE student_id='$user'");
...
//     $course_id = $_POST['package_id'];



     
    
//     // include("PHPLibrary/index.php");
                  ...
                  <div class="card card-body border p-4">
                    ...
                    <div class="mt-3 d-grid">
                        <?php
                            if(!isset($_COOKIE['student_id'])){
                                ?>
                                <a href="dashboard/login.php?login" class="btn btn-success">Buy now</a>
                                <?php
                            }else{
                                ?>
                                    <form method='post'>
