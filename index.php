      ...
      <div class="container">
        <div class="row align-items-center justify-content-xl-between g-4 g-md-5">
          ...
          <div class="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
            <!-- Badge -->
            <!--<h6 class="mb-3 font-base bg-primary bg-opacity-10 text-primary py-2 px-4 rounded-2 d-inline-block">Ahmmed Imtiaz</h6>-->
            <!-- Title -->
            <h1 class="mb-4 display-5">Dr Sohrab Hossain
              <span class="position-relative d-inline-block">
              </span>
            </h1>
            <!-- Content -->
            <p class="mb-3">Hi' i am Dr.Sohrab Hossain, practicing internal medicine and Endocrinology as my profession.Now studies MRCP(UK) at Royal College of physicians, FCPS in Endocrinology & Metabolism at Bangladesh College of physicians and surgeon . I am the CEO and Founder of " MRCP guidelines Academy" is a trusted way of taking MRCP-UK exam preparation.
            </p>
            <!-- Search bar -->
          ...
          <div class="col-lg-5 col-xl-6 text-center position-relative">
            ...
            <div
              ...
              <div class="d-flex justify-content-between">
                <!-- Avatar -->
                <div class="avatar">
                  <img class="avatar-img rounded-circle shadow" src="exam.seiinnovations.com/assets/images/avatar/photop.png" alt="avatar">
                </div>
                <!-- Info -->
          ...
          <div class="col-md-6 col-xl-4">
            <div class="card shadow-hover overflow-hidden">
              ...
              <div class="card-body">
                ...
                <!-- Title -->
                <h5 class="card-title"><a href="checkout.php?id=<?=$res['package_id']?>"
                ...
                <div class="card p-2 shadow">
                  <div class="overflow-hidden rounded-3 h-xl-200px">
                    ...
                    <div class="card-img-overlay d-flex p-3">
                      ...
                      <div class="m-auto">
                        <a href="" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox=""
